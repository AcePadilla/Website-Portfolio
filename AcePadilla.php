...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="Padilla.css">
        <link rel="icon" href="certificates/alas.png">
        <script src="https://kit.fontawesome.com/aed89df169.js" crossorigin="anonymous"></script>
        <!-- =====BOX ICONS===== -->
        <link href='https://cdn.jsdelivr.net/npm/boxicons@2.0.5/css/boxicons.min.css' rel='stylesheet'>
        <title>Ace Profile</title>
    </head>
    <body>
        <!--===== HEADER =====-->
            ...
            <nav class="nav bd-grid">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="Works2.html" class="nav__link"><i class="fa-solid fa-folder-closed"></i></a></li>
        ...
        <main class="l-main">
            ...
            <section class="home bd-grid" id="home">
                <div class="home__data">
                    <h1 class="home__title">Hello,<br>I'am <span class="home__title-color">Ace</span><br>Web <span id="typewriter"></span><span id="cursor">|</span></h1>
                ...
                <div class="home__social">
                    <a href="https://www.facebook.com/Eeeyyyssss" class="home__social-icon"><i class="fa-brands fa-facebook"></i></a>
                    <a href="https://www.instagram.com/ace_.padilla/" class="home__social-icon"><i class='bx bxl-instagram' ></i></a>
                    <a href="https://twitter.com/acepadilla_" class="home__social-icon"><i class="fa-brands fa-x-twitter"></i></a>
                    <a href="mailto:acepadillaace@gmail.com" class="home__social-icon"><i class="fa-solid fa-envelope"></i></a>
                </div>
            ...
            <section class="about section " id="about">
                ...
                <div class="about__container bd-grid">
                    ...
                    <div>
                        <h2 class="about__subtitle">I am Ace</h2>
                        <p class="about__text">Living in Gapan City, Nueva Ecija. I am 19 years old. studying at Araullo University in the bachelor's course in science of information technology South 1. My hobbies are playing online games, chess, and watching movies. I also like to go out with my friends and families. My website serves as a platform to showcase my projects, share experiences, and connect with the tech community as I work towards my dream of becoming a full-stack developer.</p>       
            ...
            <section class="skills section" id="skills">
                ...
                <div class="skills__container bd-grid">          
                    ...
                    <div>              
                        <img src="certificates/undraw_Programming_re_kg9v-removebg-preview.png" alt="" class="skills__img">
            ...
            <section class="work section" id="work">
                ...
                <div class="work__container bd-grid">
                    <img class="work__img" src="certificates/studentevalsyspic.PNG" alt="">
                    <img class="work__img" src="certificates/hcs.PNG" alt="">
                    <img class="work__img" src="certificates/crt.jpg" alt="">
                    <img class="work__img" src="certificates/cap3.PNG" alt="">
                    <img class="work__img" src="certificates/Capture2.PNG" alt="">
                    <img class="work__img" src="certificates/design2.jpg" alt="">
                </div>
            </section>
        ...
        <script>
            ...
            icon.onclick = function(){
                ...
                if(document.body.classList.contains("dark-theme")){
                    icon.src="certificates/sun.png"
                }else{
                    icon.src="certificates/moon.png"
                }
            }
        </script>
</html>